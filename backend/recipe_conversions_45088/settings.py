"""
Django settings for recipe_conversions_45088 project.
...
ROOT_URLCONF = 'recipe_conversions_45088.urls'
...
WSGI_APPLICATION = 'recipe_conversions_45088.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "recipe_conversions_45088 API",
    "DESCRIPTION": "API documentation for recipe_conversions_45088 App",
    "VERSION": "v1",
}
